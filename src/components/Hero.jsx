        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-7">
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/25 text-sm font-mono text-blue-400 shadow-[0_0_20px_rgba(59,130,246,0.08)]">
              ...
              Full Stack Developer Intern · WebIdeal
            </span>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="mt-5 font-mono text-base text-gray-400 flex items-center gap-2">
            ...
            <TypeAnimation
              sequence={[
                ...
                "Backend Engineer", 1800,
                "React Developer", 1800,
                "Problem Solver", 1800,
                "Hackathon Finalist", 1800,
              ]}
              speed={55}
              repeat={Infinity}
          ...
          <motion.p variants={itemVariants} className="mt-6 text-gray-400 max-w-lg leading-relaxed text-[15px] md:text-base">
            ...
            <span className="text-white font-semibold">Full Stack Developer Intern</span> while
            building real-world products and competing in national-level tech challenges.
          </motion.p>
          ...
          {/* Stats */}
          <motion.div variants={itemVariants} className="mt-12 relative flex gap-8">
            {[
              { val: "MERN", label: "Stack" },
              { val: "8+", label: "Projects" },
              { val: "Top 32", label: "iDEA 2.0" },
              { val: "B.Tech", label: "CSE 2027" },
            ].map(({ val, label }, i) => (
              <div key={label} className="relative text-center">
                ...
                {/* Tiny animated signal line linking Full Stack Developer to the hackathon result */}
                {i === 1 && (
                  <motion.span
                    ...
                    style={{ originX: 0 }}
                    className="absolute -left-8 top-2 w-8 h-px bg-gradient-to-r from-blue-500/60 to-blue-500/0"
                  />
                )}
              </div>
            ))}
