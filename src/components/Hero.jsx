    ...
    <section  id="home"className="relative min-h-screen flex items-center pt-32 overflow-hidden
      ...
      <div className="relative max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl lg:text-6xl font-extrabold leading-tight text-white">
            Hi, I’m <span className="text-blue-500">Yash</span>
            <br />
         I design and build <span className="text-blue-500 text-7xl">scalable web applications</span>
         </h1>
           
         <p className="mt-8 text-xl md:text-2xl text-gray-400 max-w-2xl leading-relaxed">
           I’m a Full Stack Developer focused on creating fast, secure, and maintainable
           web applications using
           <span className="text-blue-400 font-semibold"> React</span>,
           <span className="text-blue-400 font-semibold"> Node.js</span>, and modern
           backend architectures that deliver real business value.
         </p>
        ...
        >
          <div className="relative group">
            ...
            <img
              src={Profile}
              alt="Profile"
              className="relative w-100 h-100 md:w-98 md:h-98
