...
const timelineData = [
  ...
  {
    year: "2026",
    title: "iDEA 2.0 — Top 32",
    subtitle: "Team Dhurandhars · National Hackathon",
    description: "Selected among the Top 32 teams from 1,500+ submissions in the national-level iDEA 2.0 Hackathon. Built ThreatLens, an AI-driven early warning system for internal and privileged-user fraud, using React, FastAPI, MongoDB, and scikit-learn with SHAP explainability for SOC analysts.",
    icon: "🏆",
    achievement: true,
  },
  {
    year: "2026 — Present",
    title: "Internship",
    subtitle: "Full Stack Developer Intern · WebIdeal Software Solutions",
    description: "Working on modern web applications across frontend, backend, API integration, databases, AI-powered features, and product enhancements as part of a remote software development internship.",
    icon: "🚀",
  },
];
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div className="relative mt-2">
            ...
            {timelineData.map((item, index) => {
              ...
              const isAchievement = !!item.achievement;
              return (
                <motion.div
                  key={index}
                ...
                >
                  ...
                  <motion.span
                    ...
                    className={`absolute left-[26px] top-7 w-4 h-4 rounded-full z-10 flex items-center justify-center
                      ...
                      ${isActive ? "border-blue-400 shadow-[0_0_18px_rgba(59,130,246,0.7)] node-pulse" : "border-slate-700 group-hover:border-slate-500"}`}
                  >
                    {isActive && (
                      <motion.span
                        initial={{ scale: 0 }}
                  ...
                  <motion.div
                    ...
                    whileInView={
                      isAchievement
                        ? { boxShadow: ["0 0 0 rgba(59,130,246,0)", "0 8px 40px rgba(59,130,246,0.18)", "0 8px 40px rgba(59,130,246,0.08)"] }
                        : {}
                    }
                    viewport={{ once: true }}
                    transition={isAchievement ? { duration: 1.1, ease: "easeOut" } : { duration: 0.3 }}
                    className={`achievement-sheen rounded-xl p-5 transition-all duration-300 border border-l-2
                      ${isActive
                        ? "bg-[#090e1c] border-blue-900/60 shadow-[0_8px_40px_rgba(59,130,246,0.08)]"
                        : "bg-transparent border-transparent hover:bg-[#090e1c]/50"}
                      ${isAchievement ? "border-blue-900/40" : ""}`}
                  >
          ...
          >
            ...
            <p className="text-gray-400 leading-relaxed mb-8">
              My primary focus is on the <span className="text-blue-400 font-semibold">MERN stack</span>, where I build real-world applications using React, Node.js, Express, and MongoDB. I'm currently a{" "}
              <span className="text-white font-semibold">Full Stack Developer Intern</span> at WebIdeal Software Solutions, working across frontend, backend, APIs, and AI-powered features — and I recently placed in the{" "}
              <span className="text-blue-400 font-semibold">Top 32 at iDEA 2.0</span>, a national-level hackathon, where my team built an AI-driven fraud-detection system.
            </p>

            {/* Tags */}
            <div className="flex flex-wrap gap-3 mb-8">
              {["Full Stack Developer", "MERN Stack", "Backend APIs", "React", "Clean Code", "Hackathon Finalist"].map((tag) => (
                <motion.span
                  key={tag}
